<%@ Page Title="MTB" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeBehind="MTB.aspx.cs" Inherits="PrograWeb.MTB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlaceHolder" runat="server">
    <div class="content">
        ...
        <div class="bg-secondary w-100 py-5 mb-5">
            <h2 class="text-center text-light py-2">MTB</h2>
        </div>

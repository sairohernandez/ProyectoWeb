...
namespace PrograWeb
{
    public partial class MTB : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                articulos = mArticulo.getArticulosPorCategoria("MTB");
        ...
        protected void Filter_Products(object sender, CommandEventArgs e)
        {
            try
            {
                List<EArticulo> articulos = new List<EArticulo>();
                DArticulo mArticulo = new DArticulo();
                articulos = mArticulo.getArticulosPorCategoria("MTB", e.CommandArgument.ToString());
                ProductosGrid.DataSource = articulos;
                ProductosGrid.DataBind();
            }
            catch (Exception ex)
